package com.example.demo.createObject;
...
//        Way 2
        ...
        try {
            CreateObjectDemo objectDemo1= (CreateObjectDemo) Class.forName("com.example.demo.createObject.CreateObjectDemo").newInstance();
